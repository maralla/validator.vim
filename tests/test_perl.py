...
def test_perlcritic():
    msg = [
        "Subroutine prototypes used at line 989, column 1.  See page 194 of PBP.  (Severity: 5)"
    ]
    ...
    assert json.loads(res[0]) == {
        "lnum": "989",
        "col": "1",
        "text": '[perlcritic]Subroutine prototypes used at line 989, column 1.  See page 194 of PBP.  (Severity: 5)',
        "enum": 1,
        "bufnr": 1,
        "type": "E",
        "code": "5",
